...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_type', default='sum_rate_ris', choices=['custom', 'power', 'rsi_elements', 'learning_rate', 'decay', 'sum_rate_ris'],
    ...
    env = environment.RIS_MISO(args.num_antennas, args.num_RIS_elements, args.num_users, AWGN_var=args.awgn_var,carrfreq=10**9,
                 alpha_t=2.2,
                 alpha_r=2.2,
                 Rican_BI=10,
                 Rican_IU=10,
